        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 bg-dark p-5 rounded">
                ...
                <form class="form-inline" method="post" action="{{route('access')}}">
                    ...
                    <div id="passwordHelpBlock" class="form-text my-1">
                        Your password must match with the one registered in our database, after three failure trials, your IP will be blocked.                    </div>
