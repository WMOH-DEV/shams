...
@section('content')
    ...
    <div class="content">
        <div
            ...
            <div>
                <h5 class="h6 mb-1">
                   <span>{{ __('global.main') }}</span><i class="fas fa-angle-left px-2"></i><span>تعديل الملف الشخصي</span>
                </h5>
                    ...
                    <div class="row push">
                        ...
                        <div class="col-lg-8 col-xl-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control invisible" id="avatar" accept="image/*" name="avatar"
                                      >
                            </div>
                        </div>
                    </div>
