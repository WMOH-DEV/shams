                                ...
                                <tr style="font-size: 0.9rem">
                                    ...
                                    <td class="font-w600">
                                        <select
                                            ...
                                            <option value="header" @if ($page->type === 'header') selected @endif>أعلى الموقع</option>
                                            <option value="footer" @if ($page->type === 'footer') selected @endif>نهاية الموقع</option>
                                        </select>
                                    </td>
                                </tr>
