    ...
    <div class="modal-content">
      <div class="block block-themed block-transparent mb-0">
        ...
        <div class="block-content">
          <p class="text-center" style="font-size: 1.1rem">هل أنت متأكد من حذف هذا التعليق ؟</p>
        </div>
          <div class="block-content block-content-full text-left bg-light py-2">
            ...
            <button type="button" wire:click="deleteSingleRecord({{$comment->id}})"  class="btn btn-sm btn-primary" data-dismiss="modal">
